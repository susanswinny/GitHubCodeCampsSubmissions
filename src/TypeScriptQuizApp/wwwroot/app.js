...
var studentInput = ''; // student's input string                        
var studentInputScrubbed = ''; // student's turn scrubbed input string
var studentInputScrubbedLengthConstant = 1; // desired length of student's input
var timesThisQuestionAnswered = 0; // number of times student has attempted answer this question
var currentScore = 0;
var pointsTotalPossible = 100;
var selectedQuestionsTotal = cannedQuestion.length;
var pointsPerQuestion = pointsTotalPossible / selectedQuestionsTotal;
var inputErrorMessage = "Your input must be only 1 character = a or b or c or d or e.";
var studentInstructionsMessage = "Answer the following question by typing the letter of the best answer:";
var correctAnswerMessage = "Your answer is correct!";
var wrongAnswerMessage = "Your answer is incorrect - try another answer.";
var currentScoreMessage1 = "Score is ";
var currentScoreMessage2 = " points out of ";
var currentScoreMessage3 = " possible points. ";
var pointsText = " points ";
var studentResponseText = "student response=";
var alertText = "";
var consoleText = "";
var studentQuestion = "";
var messageType = '';
var messageTypeConsole = 'console';
var messageTypePromptOrAlert = 'promptOrAlert';
var messageNumberStudentQuestionInitial = 0;
var messageNumberStudentResponse = 1;
var messageNumberStudentCorrectAnswer = 2;
var messageNumberStudentWrongAnswer = 3;
var messageNumberStudentAcedIt = 4;
var messageNumberStudentDidQuiteWell = 5;
var validInput = false; // indicates whether student's edited input is valid
var quizIsOver = false; // terminate quiz for whatever reason
var studentCanceledQuiz = false; // student intentionally canceled quiz intentionally by clicking CANCEL or CLOSE button
var endOfQuestion = false; // endOfQuestion = true when validInput is true or studentCanceledQuiz is true or quizIsOver is true
// select questions for the quiz from the canned set of questions which can be randomized for variety
for (var i = 0; i < selectedQuestionsTotal; i++) {
...
///////////////////////////////////////////////////////////////////////////////////////////
for (var questionIndex = 0; questionIndex < selectedQuestionsTotal; questionIndex++) {
    ...
    if (studentCanceledQuiz) {
        break;
    } // break out of for loop - no more questions
...
///////////////////////////////////////////////////////////////////////////////////////////
function buildText(parmMessageNumber, parmMessageType, parmQuestionIndex) {
    var returnText = "";
